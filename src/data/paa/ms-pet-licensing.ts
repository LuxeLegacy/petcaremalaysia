...
export const msPetLicensingArticle: PAAArticle = {
  ...
  directAnswer: 'Lesen anjing di Malaysia berharga RM10–RM50 setahun, dibayar kepada pihak berkuasa tempatan (PBT) seperti DBKL atau MBPJ. Anjing mesti dilesenkan dalam tempoh 3 bulan pemilikan. Vaksin rabies sah adalah wajib, dan sesetengah PBT memerlukan microchip. Kucing umumnya tidak memerlukan lesen.',
  tldr: 'Lesen anjing Malaysia: RM10–RM50 setahun dari PBT (DBKL, MBPJ). Lesenkan dalam 3 bulan. Vaksin rabies wajib; sesetengah kawasan perlu microchip. Anjing tanpa lesen boleh ditahan. Kucing umumnya tidak perlu lesen.',
