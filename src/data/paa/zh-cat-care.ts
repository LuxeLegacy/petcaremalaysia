...
export const zhCatCareArticle: PAAArticle = {
  ...
  directAnswer:
    '在马来西亚养猫每月费用为RM150至RM400。基本开销包括优质猫粮（RM80–RM200）、每月跳蚤防治（RM30–RM60）、每年FVRCP加狂犬疫苗（RM80–RM200），以及一次性绝育（RM150–RM400）。建议室内饲养以避免车祸和流浪猫传染的疾病。',
  tldr: '马来西亚养猫每月RM150–RM400。预算包括优质猫粮、每月跳蚤防治、每年FVRCP加狂犬疫苗，及一次性绝育。室内饲养可防车祸与流浪猫疾病传播。',
  quickFacts: {
