...
export const msPetMicrochippingArticle: PAAArticle = {
  ...
  directAnswer: 'Microchip haiwan peliharaan di Malaysia berharga RM50–RM120, termasuk chip, prosedur tanam, dan pendaftaran. Prosedur mengambil masa kurang 5 minit di klinik veterinar dan hampir tanpa rasa sakit. Microchip kini wajib untuk lesen anjing di beberapa negeri dan sangat disyorkan untuk semua haiwan.',
  tldr: 'Microchip haiwan Malaysia: RM50–RM120 sekali bayar termasuk chip, tanam dan daftar. Kurang 5 minit di mana-mana klinik veterinar. Wajib untuk lesen anjing di beberapa negeri. Kemas kini maklumat hubungan jika berpindah rumah.',
