...
export const zhPetDentalCareArticle: PAAArticle = {
  ...
  directAnswer:
    '马来西亚宠物专业洁牙费用为RM200至RM800，具体取决于麻醉要求、诊所类型和宠物大小。基础洁牙约RM200–RM400，需要拔牙或治疗牙周病的复杂病例可达RM500–RM800+。',
  tldr: '宠物洁牙费用：马来西亚基础洁牙RM200–RM400，复杂病例（含拔牙）RM500–RM800+。所有宠物洁牙均需全身麻醉，这是费用的主要组成部分。',
  quickFacts: {
    avgCost: 'RM200 – RM800',
