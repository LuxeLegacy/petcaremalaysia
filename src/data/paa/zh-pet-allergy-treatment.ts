...
export const zhPetAllergyTreatmentArticle: PAAArticle = {
  ...
  directAnswer:
    '马来西亚宠物过敏的初始诊断费用为RM200至RM800（包括皮肤测试或血液检查），持续治疗费用为每月RM150至RM500+，具体取决于过敏类型和严重程度。最常见的过敏类型是跳蚤过敏、食物过敏和环境过敏。',
  tldr: '宠物过敏治疗：诊断RM200–RM800，持续治疗RM150–RM500/月。马来西亚热带气候使环境过敏非常普遍。早期识别和管理可显著降低长期费用。',
  quickFacts: {
