...
export const zhPetSpayingNeuteringArticle: PAAArticle = {
  ...
  title: '马来西亚宠物绝育费用是多少？',
  directAnswer:
    '马来西亚母宠物结扎费用为RM200–RM700，公宠物去势费用RM150–RM500。政府兽医诊所（DVS）和SPCA等福利团体提供RM30–RM100的补贴价格。手术可预防癌症、避免意外繁殖和减少行为问题。恢复期约10–14天。',
  tldr: '马来西亚结扎/去势：母RM200–RM700，公RM150–RM500。DVS与SPCA提供RM30起的补贴方案。手术预防癌症、意外繁殖与行为问题。恢复期10–14天。建议第一次发情前完成。',
  quickFacts: {
