...
export const zhPetFirstAidKitArticle: PAAArticle = {
  ...
  directAnswer:
    '马来西亚宠物急救包应包含以下必需品：绷带和纱布、消毒水（氯己定）、镊子、数字温度计、口罩、止血带、医用胶带、防过敏手套、电筒，以及最重要的——当地紧急兽医的联系电话。组建一套完整急救包的成本约为RM80–RM200。',
  tldr: '宠物急救包必备物品：绷带、消毒水、镊子、温度计、手套、止血带和紧急兽医电话。成本RM80–RM200。急救只是应急措施，必须尽快送往兽医！',
  quickFacts: {
