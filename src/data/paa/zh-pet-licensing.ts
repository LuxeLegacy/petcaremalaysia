...
export const zhPetLicensingArticle: PAAArticle = {
  ...
  directAnswer:
    '马来西亚犬主必须向当地市政局注册并每年更新执照，费用通常为每只狗RM10–RM50/年（具体取决于市政局和是否已绝育）。猫咪目前在大多数地区无需注册。未注册犬只可能被没收，主人面临罚款。',
  tldr: '马来西亚犬只注册：RM10–RM50/年（视市政局而定）。需提供狂犬病疫苗证书。猫咪通常无需注册。未注册犬只可被没收。通过所在地区的市政局（DBKL、MBPJ等）办理注册。',
  quickFacts: {
