...
export const zhDogVaccinesArticle: PAAArticle = {
  ...
  directAnswer:
    '马来西亚的狗需要接种核心疫苗，包括DHPP（犬瘟热、肝炎、细小病毒、副流感），从6–8周龄开始，在10–12周和14–16周加强接种，以及法律规定的年度狂犬疫苗。非核心疫苗如钩端螺旋体病和犬窝咳也强烈建议接种。',
  tldr: '幼犬需要在6–8、10–12和14–16周龄接种3轮DHPP疫苗，加上12–16周龄的狂犬疫苗。需要年度加强针。全套幼犬疫苗费用RM200–RM500。狂犬疫苗在马来西亚是法律强制要求。因热带气候，强烈建议接种钩端螺旋体病疫苗。',
  quickFacts: {
