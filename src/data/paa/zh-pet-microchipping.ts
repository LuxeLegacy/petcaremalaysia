...
export const zhPetMicrochippingArticle: PAAArticle = {
  ...
  directAnswer:
    '马来西亚宠物植入晶片费用为RM50–RM120，包括芯片、植入和登记。程序在任何兽医诊所5分钟内完成，几乎无痛。多个州属现要求狗只执照须有晶片，强烈建议所有猫狗都植入。',
  tldr: '马来西亚宠物晶片：一次性RM50–RM120，含晶片、植入与登记。任一兽医5分钟内完成。多州狗只执照已强制晶片。搬家后请更新登记资料。',
  quickFacts: {
    avgCost: 'RM50 – RM150',
    timeRequired: '5–10分钟',
    difficulty: '简单',
