...
export const zhPetTravelArticle: PAAArticle = {
  ...
  title: '马来西亚宠物旅行有什么要求？',
  directAnswer:
    '携带宠物出入马来西亚需办理DVS进出口准证（RM50–RM200）、提前至少30天接种狂犬疫苗、植入晶片、兽医健康证明及航空公司认可的运输箱。总费用RM500–RM3,000，视目的地而定。请提前8–12周开始准备。',
  tldr: '马来西亚宠物出境：需DVS准证（RM50–RM200）、狂犬疫苗、晶片、兽医健康证明及IATA标准运输箱。总费RM500–RM3,000。宠物搬迁代理收RM2,000–RM8,000。请提前8–12周准备。',
  quickFacts: {
