...
export const zhSeniorPetCareArticle: PAAArticle = {
  ...
  title: '如何照顾马来西亚的老年宠物？',
  directAnswer:
    '马来西亚老年宠物照护每年额外费用RM500–RM2,000+。狗7–10岁、猫10–12岁即进入老年期。每半年一次兽医检查、关节补充剂（每月RM80–RM200）、特殊饮食（每月加RM50–RM120）以及慢性病用药是主要开销。',
  tldr: '马来西亚老年宠物照护：每年额外RM500–RM2,000+。狗7–10岁、猫10–12岁起步入老年。每半年体检、关节补充剂（每月RM80–RM200）与特殊饮食。及早发现关节炎与肾病。',
  quickFacts: {
