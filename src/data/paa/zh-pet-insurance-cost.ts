...
export const zhPetInsuranceCostArticle: PAAArticle = {
  ...
  title: '马来西亚宠物保险费用是多少？',
  directAnswer:
    '马来西亚宠物保险每月费用为RM95–RM300。仅限意外的基本保单从RM95起，涵盖疾病、手术和保健的全面保单可达RM300+。保费随宠物年龄和品种风险上升。最受欢迎的提供商为Oyen和MSIG。原有疾病不在承保范围内。',
  tldr: '马来西亚宠物保险：每月RM95–RM300。意外险从RM95起，全面险从RM200起。保费随年龄与品种增加。主要提供商：Oyen与MSIG。务必在宠物年轻健康时投保。',
  quickFacts: {
